...
var $author$project$Main$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{activeButton: $elm$core$Maybe$Nothing, animatedButton: $elm$core$Maybe$Nothing, currentLevel: 0, currentSequence: _List_Nil, userSequence: _List_Nil},
...
var $author$project$Main$ClearActiveButton = {$: 'ClearActiveButton'};
var $author$project$Main$ClearAnimatedButton = {$: 'ClearAnimatedButton'};
var $author$project$Main$RandomResult = function (a) {
	return {$: 'RandomResult', a: a};
};
var $author$project$Main$SetActiveButton = function (a) {
	return {$: 'SetActiveButton', a: a};
};
...
var $author$project$Main$showSequence = function (sequence) {
	return $elm$core$String$concat(
		A2($elm$core$List$map, $elm$core$String$fromInt, sequence));
};
var $author$project$Main$gameIsInProgress = function (model) {
	return (!_Utils_eq(model.currentSequence, _List_Nil)) && (_Utils_eq(model.userSequence, _List_Nil) || ((!_Utils_eq(model.userSequence, _List_Nil)) && (A2(
		$elm$core$String$startsWith,
		$author$project$Main$showSequence(model.userSequence),
		$author$project$Main$showSequence(model.currentSequence)) && (!_Utils_eq(model.currentSequence, model.userSequence)))));
};
...
var $author$project$Main$sequenceLengthFromLevel = function (level) {
	return level + 1;
};
		...
		switch (msg.$) {
			case 'StartGame':
				var newModel = _Utils_update(
					model,
					{currentLevel: model.currentLevel + 1, userSequence: _List_Nil});
				var cmd = A2(
					$elm$random$Random$generate,
					$author$project$Main$RandomResult,
					A2($elm$random$Random$int, 0, 8));
				return _Utils_Tuple2(
					newModel,
					(!model.currentLevel) ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[cmd, cmd])) : cmd);
			case 'RandomResult':
				var n = msg.a;
				...
				var cmds = A2(
					...
					F2(
						function (i, m) {
							return A2($author$project$Main$delay, i * 200, m);
						}),
					function (xs) {
						return _Utils_ap(
							xs,
							_List_fromArray(
								[$author$project$Main$ClearActiveButton]));
					}(
						A2(
							$elm$core$List$intersperse,
							$author$project$Main$ClearActiveButton,
							A2($elm$core$List$map, $author$project$Main$SetActiveButton, newSequence))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentSequence: newSequence}),
					_Utils_eq(
						$elm$core$List$length(newSequence),
						$author$project$Main$sequenceLengthFromLevel(model.currentLevel)) ? $elm$core$Platform$Cmd$batch(cmds) : $elm$core$Platform$Cmd$none);
			case 'AddToUserSequence':
				var n = msg.a;
				return ($author$project$Main$gameIsInProgress(model) || (_Utils_eq(model.userSequence, _List_Nil) && (!_Utils_eq(model.currentSequence, _List_Nil)))) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animatedButton: $elm$core$Maybe$Just(n),
							userSequence: _Utils_ap(
								model.userSequence,
								_List_fromArray(
									[n]))
						}),
					A2($author$project$Main$delay, 250, $author$project$Main$ClearAnimatedButton)) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'Reset':
				return $author$project$Main$initialModel(_Utils_Tuple0);
			case 'SetActiveButton':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeButton: $elm$core$Maybe$Just(n)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ClearActiveButton':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{activeButton: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animatedButton: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$gameHasNotStartedYet = function (model) {
	return _Utils_eq(model.currentSequence, _List_Nil) && _Utils_eq(model.userSequence, _List_Nil);
};
...
var $author$project$Main$userWon = function (model) {
	return _Utils_eq(model.currentSequence, model.userSequence) && (!_Utils_eq(model.currentSequence, _List_Nil));
};
var $author$project$Main$gameState = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$h1,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Main$gameHasNotStartedYet(model) ? $rtfeldman$elm_css$Html$Styled$text('Game hasn\'t started yet.') : ($author$project$Main$userWon(model) ? $rtfeldman$elm_css$Html$Styled$text('User wins! Next level!') : ($author$project$Main$gameIsInProgress(model) ? $rtfeldman$elm_css$Html$Styled$text(
				'Level: ' + $elm$core$String$fromInt(model.currentLevel)) : $rtfeldman$elm_css$Html$Styled$text('You lost...')))
			]));
};
...
var $author$project$Main$AddToUserSequence = function (a) {
	return {$: 'AddToUserSequence', a: a};
};
...
var $author$project$Main$activeButtonStyle = $elm$core$List$singleton(
	...
	function (model, idx) {
		...
		var attrs = _List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('animate__animated', true),
						_Utils_Tuple2('animate__faster', true),
						_Utils_Tuple2(
						'animate__backInRight',
						_Utils_eq(model.activeButton, $elm$core$Maybe$Nothing) && (!model.currentLevel)),
						_Utils_Tuple2(
						'animate__jello',
						_Utils_eq(
							model.animatedButton,
							$elm$core$Maybe$Just(idx)) || _Utils_eq(
							model.activeButton,
							$elm$core$Maybe$Just(idx))),
						_Utils_Tuple2('playingButton', true),
						_Utils_Tuple2(
						'startButtons',
						_Utils_eq(model.animatedButton, $elm$core$Maybe$Nothing) && _Utils_eq(model.activeButton, $elm$core$Maybe$Nothing))
					])),
				$rtfeldman$elm_css$Html$Styled$Events$onClick(
				$author$project$Main$AddToUserSequence(idx))
			]);
		return A2(
		...
		_List_fromArray(
			[
				...
				'Score: ' + $elm$core$String$fromInt(
					$author$project$Main$countScore(model.currentLevel))) : $rtfeldman$elm_css$Html$Styled$text(
				'Score: ' + $elm$core$String$fromInt(
					$author$project$Main$countScore(model.currentLevel - 1))))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$gameStyle)
					]),
				_List_fromArray(
					[
						$author$project$Main$gameState(model),
						$author$project$Main$points(model),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
						...
						A2(
							$elm$core$List$map,
							$author$project$Main$makeButton(model),
